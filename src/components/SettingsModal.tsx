...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-950/60 backdrop-blur-xs flex items-center justify-center p-4">
      <div 
        id="modal-settings"
        className="bg-white border border-slate-200 rounded-2xl max-w-lg w-full shadow-2xl overflow-hidden flex flex-col text-slate-900"
      >
        {/* Modal Header */}
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4 text-xs">
          ...
          <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-2.5 pt-3">
            ...
            {importStatus && (
              <div className="p-2 bg-emerald-50 border border-emerald-300 text-emerald-800 rounded-lg font-semibold text-[11px] flex items-center gap-1">
            ...
            <div className="flex flex-wrap items-center gap-2 pt-1">
              ...
              <button
                ...
                className="bg-white hover:bg-slate-100 text-slate-800 font-bold px-3 py-1.5 border border-slate-200 rounded-lg text-xs flex items-center gap-1.5 shadow-2xs cursor-pointer"
              >
              ...
              {/* Import Button */}
              <label className="bg-white hover:bg-slate-100 text-slate-800 font-bold px-3 py-1.5 border border-slate-200 rounded-lg text-xs flex items-center gap-1.5 shadow-2xs cursor-pointer">
              ...
              <button
                ...
                className="text-slate-500 hover:text-red-600 text-xs px-2 py-1.5 rounded-lg flex items-center gap-1 ml-auto cursor-pointer font-semibold"
              >
          ...
          <div className="pt-3 border-t border-slate-200 flex items-center justify-between">
            ...
            <button
              type="submit"
              className="px-5 py-2 bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs rounded-xl shadow-xs flex items-center gap-1 cursor-pointer"
            >
